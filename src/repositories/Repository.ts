...
export class Repository<T extends Entity> {
    ...
    async create(entity: T): Promise<T> {
        ...
        try {
            ...
            const result = await client.query(`SELECT * FROM ${this.tableName} WHERE id = '${entity.id}'`);
    ...
    async findAll(field?: string, order?: string, filter?: Record<string, any>): Promise<Array<T>> {
