...
export function writeJson(response: any, arg1: any, responseCode?: number): void {
...
export function getItemResponseHandler<T>(res: Response) {
    return (entity: T) => {
        ...
        const response = { code: 404, success: false, message: 'Not Found', timestamp: (new Date()).toUTCString() } as ErrorResponseNotFound;
